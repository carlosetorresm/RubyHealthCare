...
class ConsultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consult" do
    assert_difference('Consult.count') do
      post consults_url, params: { consult: { doctor_id: @consult.doctor_id, patient_id: @consult.patient_id, speciality_id: @consult.speciality_id, symptoms: @consult.symptoms } }
    end
  ...
  test "should update consult" do
    patch consult_url(@consult), params: { consult: { doctor_id: @consult.doctor_id, patient_id: @consult.patient_id, speciality_id: @consult.speciality_id, symptoms: @consult.symptoms } }
