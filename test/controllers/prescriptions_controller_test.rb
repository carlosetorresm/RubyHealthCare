...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { body: @prescription.body, consult_type_id: @prescription.consult_type_id, doctor_id: @prescription.doctor_id, patient_id: @prescription.patient_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { body: @prescription.body, consult_type_id: @prescription.consult_type_id, doctor_id: @prescription.doctor_id, patient_id: @prescription.patient_id } }
